...
# ...................................................
##### Issue 7: Remove everything after a symbol #####
# ...................................................

removeAfter = function(d, header, separator) {
  
  # This function removes everything after a designated symbol
  
  if (header %in% colnames(d)) {
    
    sep_removeAfter = paste0(separator, ".*")
    
    d[ , header] = gsub(sep_removeAfter, "", d[ , header])
